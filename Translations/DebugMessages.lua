local debugMessagesLocales = {
    ...
    ["Toggles the My Journey window"] = "Показати/приховати вікно 'Моя подорож'",
    ...
    ["Setting icon limit value to %s : Redrawing!"] = "Обмедення кількості значків до %s : Перемальовування!",
